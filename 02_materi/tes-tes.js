...
// mengecek apakah isi array bernilai number atau tidak menggunakan method oop
// function Array() {
//     this.every = allNums, allNums2;
// }

Array.prototype.isAllNumber = function() {
    console.log(this);
    return this.every((element) => typeof element === "number");
}

const allNums = [1, 2, 3].isAllNumber();
const allNums2 = [1, "2", 3].isAllNumber();
console.log({ allNums, allNums2 });